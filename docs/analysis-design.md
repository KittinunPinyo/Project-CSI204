...
flowchart LR
    ...
    %% --- การเชื่อมต่อฝั่งขวา ---
    %% โยงจาก Use Case ในกรอบไปหา Admin ทำให้ Admin โดนผลักไปอยู่ขวาสุด
    A1 --- Admin
    A2 --- Admin
    A3 --- Admin
    A4 --- Admin
    ...
    %% Include ฝั่งแอดมิน (ใช้เส้นประมาตรฐาน ไม่ใช้เส้นย้อนกลับเพื่อป้องกัน GitHub Error)
    A2 -. "<< include >>" .-> I_A2_1
    A2 -. "<< include >>" .-> I_A2_2
    A2 -. "<< include >>" .-> I_A2_3
    A3 -. "<< include >>" .-> I_A3_1
